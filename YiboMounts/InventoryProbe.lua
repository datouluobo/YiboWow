...
function NS.InventoryProbe:Capture()
    ...
    YiboMountsDiagnostics = YiboMountsDiagnostics or {}
    YiboMountsDiagnostics.mountInventory = {
    ...
    return YiboMountsDiagnostics.mountInventory
end
...
function NS.InventoryProbe:PrintCapture()
    ...
    NS.Probe.Print("exit the game once, then share the YiboMountsDiagnostics SavedVariables file for catalog import")
end
