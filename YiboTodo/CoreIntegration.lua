...
function Integration:Initialize()
    ...
    local page, pageErr = Core.AccountView:RegisterPage(Addon.NAME, {
        id = "todo", title = "账号待办", icon = ICON, order = 35, defaultEnabled = true, previewEnabled = true, scope = { mode = "realms", allTitle = "所有服务器" },
        ...
        Create = Addon.AccountPage.Create, Refresh = Addon.AccountPage.Refresh, GetSurfaceMetrics = Addon.AccountPage.GetSurfaceMetrics,
