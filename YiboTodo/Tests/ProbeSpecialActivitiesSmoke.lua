...
assert(Probe:StartSpecial("brewfest"), "brewfest probe starts")
Probe:CaptureEvent("CHAT_MSG_LOOT", "你获得了物品：[节日酒桶]。")
assert(#Probe.specialCapture.eventTrace == 1, "brewfest probe keeps automatic reward messages")
assert(Probe:FinishSpecial("brewfest"), "brewfest probe finishes")
...
SlashCmdList.YIBOTODO("probe brewfest-start")
assert(Probe.specialCapture and Probe.specialCapture.kind == "brewfest", "slash command starts the brewfest probe")
SlashCmdList.YIBOTODO("probe brewfest-finish")
