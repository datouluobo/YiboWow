...
local groups = {
    { id = "mop.engineering.jards-energy-source", activityID = "profession.cooldown.mop.engineering.jards-energy-source", professionID = 202, requiredSkillLevel = 600, aggregation = "single-recipe", resetPolicyID = "daily-07", resetKind = "daily-07", resetHour = 7, defaultMode = "required", label = "贾德的特制能量源", order = 10, active = true },
    ...
    { id = "mop.leatherworking.magnificent-fur", activityID = "profession.cooldown.mop.leatherworking.magnificent-fur", professionID = 165, requiredSkillLevel = 600, aggregation = "single-recipe", resetPolicyID = "daily-07", resetKind = "daily-07", resetHour = 7, defaultMode = "required", label = "华丽毛皮", order = 10, active = true },
