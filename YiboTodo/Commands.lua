...
SlashCmdList.YIBOTODO = function(input)
    ...
    elseif command == "help" then
        Addon:Print("命令：/ytd（打开账号页）；/ytd nomi-debug；/ytd action-debug；/ytd probe nat-start|snapshot|finish；/ytd probe brilltron-start|snapshot|finish；/ytd status；/ytd validate。")
