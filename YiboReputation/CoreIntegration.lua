...
local function GetSurfaceMetrics(context)
 ...
 local layout = Addon.MatrixColumnLayout or { nameWidth = 200, characterWidth = 60 }
 ...
 return {
  ...
  naturalContentWidth=matrixWidth+inset.left+inset.right+(rows>20 and Core.UITheme.Geometry.scrollbarGutter or 0),
  ...
  fixedLeftWidth=layout.nameWidth,fixedTopHeight=Core.UITheme.Size.standard+Core.UITheme.Table.headerHeight,horizontalOverflow="paginate",verticalOverflow="content"
 }
end
