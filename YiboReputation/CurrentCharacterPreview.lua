...
function Addon:RefreshCurrentPreview(parent)
    ...
    parent.currentPreviewValueHeader:ClearAllPoints();parent.currentPreviewValueHeader:SetPoint("TOPRIGHT",parent,"TOPRIGHT",-Theme.Space.xl,-(Theme.Space.xs+Theme.Size.standard+Theme.Space.xs+Theme.Size.compact));parent.currentPreviewValueHeader:SetText(character and character.name or "当前角色")
    parent.currentPreviewScroll:ClearAllPoints();parent.currentPreviewScroll:SetPoint("TOPLEFT",parent.currentPreviewNameHeader,"BOTTOMLEFT",0,-Theme.Space.xxs);parent.currentPreviewScroll:SetPoint("BOTTOMRIGHT",parent,"BOTTOMRIGHT",-Theme.Space.xl,Theme.Space.sm)
