...
YiboAltoBoss is a World of Warcraft addon for Mists of Pandaria Classic that tracks world boss weekly kills and Warbringer observations across your characters. Version 2.1.2 requires YiboCore API v5 and uses its unified account page, character directory, optional entry, and settings navigation.
