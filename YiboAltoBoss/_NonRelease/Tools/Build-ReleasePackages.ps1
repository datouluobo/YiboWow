...
try {
    ...
    Compress-Archive -LiteralPath $cfStage -DestinationPath $cfZip -CompressionLevel Optimal -Force
    ...
    Compress-Archive -LiteralPath $githubStage -DestinationPath $githubZip -CompressionLevel Optimal -Force
